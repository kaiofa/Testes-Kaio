# Pergunta 11 — Relatório de Execução de Interface (1)
...
* **CT01 — Login válido:** Resultado esperado: Redirecionamento para Home com título visível. Resultado obtido: Redirecionamento realizado e título exibido com sucesso. Status: Aprovado.
